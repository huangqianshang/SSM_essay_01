...
<body class="hold-transition skin-purple sidebar-mini">
							...
							<table id="collapse-table"
								...
								<tbody>
									<c:forEach items="${user.roles}" var="role">
										<tr data-tt-id=${role.roleName } data-tt-parent-id="0">
											<td>${role.roleName }</td>
											<td>${role.roleDesc }</td>
										</tr>
										<c:forEach items="${role.permissions}" var="permission">
											<tr data-tt-id="1-1" data-tt-parent-id=${role.roleName }>
                                    ...
                                    <div class="row data-type">
                                        ...
                                        <div class="col-md-4 data">
                                            <input type="text" class="form-control" name="username"
                                                   placeholder="用户账号" readonly value=${user.username }>
                                        </div>
                                        ...
                                        <div class="col-md-4 data">
                                            <select class="form-control select2" style="width: 100%"
                                                    name="status">
                                                <c:if test="${'未开启' ==user.getStringStatus() }">
                                                    <option value="0" selected="selected">关闭</option>
                                                    <option value="1">开启</option>
                                                </c:if>
                                                <c:if test="${'开启'==user.getStringStatus() }">
	...
	<script>
		...
		$(function () {
            $("#collapse-table").treetable({ expandable : true , treeColumn : 2});
        });
