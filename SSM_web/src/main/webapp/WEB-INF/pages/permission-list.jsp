...
<%--										<th class="text-center">操作</th>--%>
                                ...
                                <c:if test="${0==pageInfo.size}">
                                    <tr>
                                        <td colspan="4" style="text-align: center;font-weight: bold;font-size: 18px">暂无数据...</td>
                                    </tr>
                                </c:if>
...
<%--											</td>--%>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/permission/findAll?pageNum=1&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/permission/findAll?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}">上一页</a></li>
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNumber">

                                    <li><a href="${pageContext.request.contextPath}/permission/findAll?pageNum=${pageNumber}&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}">${pageNumber}</a></li>

                                </c:forEach>

                                <li><a href="${pageContext.request.contextPath}/permission/findAll?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/permission/findAll?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}" aria-label="Next">尾页</a>
                                </li>
							</ul>
						</div>
		...
		<script>
            ...
            function search(){
                ...
                location.href = '/permission/findAll?pageNum='+1+
