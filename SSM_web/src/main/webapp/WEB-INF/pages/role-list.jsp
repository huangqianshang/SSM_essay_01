				...
				<div class="box box-primary">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission?id=${role.id}" class="btn bg-olive btn-xs">添加资源权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/role/findAll?pageNum=1&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/role/findAll?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}">上一页</a></li>
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNumber">

                                    <li><a href="${pageContext.request.contextPath}/role/findAll?pageNum=${pageNumber}&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}">${pageNumber}</a></li>

                                </c:forEach>

                                <li><a href="${pageContext.request.contextPath}/role/findAll?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/role/findAll?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}&keyValue=${keyValue}" aria-label="Next">尾页</a>
                                </li>
							</ul>
						</div>
